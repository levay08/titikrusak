...
// Modal selamat datang (hanya saat KUNJUNGAN PERTAMA per browser — flag
// localStorage "titikrusak_welcome_seen"; setelah tombol "Mengerti" tidak
// muncul lagi, termasuk saat kembali ke halaman pertama pada sesi yang
// masih ada). Berisi latar belakang singkat, solusi, fitur, dan ajakan
// melihat Dokumentasi serta melapor dengan e.id. Logo transparan besar di
// latar belakang panel agar desain rapi dan modern.
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
          <Logo size={40} />
          <div>
            <div style={{ fontSize: 20, fontWeight: 800, color: '#1c1917', lineHeight: 1.2 }}>
              Selamat Datang di titikrusak.id
            </div>
        ...
        <ul style={{ margin: '0 0 12px', paddingLeft: 18, fontSize: 12.5, lineHeight: 1.7, color: '#475569' }}>
          <li>Peta interaktif seluruh Indonesia dengan 96+ titik laporan nyata.</li>
